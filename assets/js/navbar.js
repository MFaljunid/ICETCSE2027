...
<nav id="navbar">
  <div class="nav-inner">
    ...
    <a href="${root}index.html" class="nav-brand">
      <img src="${root}assets/images/logo-mitk.png" 
           class="nav-mitk-logo" 
           alt="MITK Logo">
    ...
    <div class="nav-right">
      ...
      <img src="${root}assets/images/logo-elsevier.png"
           class="nav-elsevier-logo"
           alt="Elsevier Procedia">
...
<footer id="footer">
  ...
  <div class="footer-inner">
    ...
    <div class="footer-brand">
      ...
      <img src="${root}assets/images/logo-elsevier.png"
           class="footer-elsevier"
           alt="Elsevier">

      <div style="margin-left:10px;">

        <div class="footer-text">
          © 2027 <span>ICETCSE-2027</span> ·
          Dept. of CSE, MIT, Kundapura, Udupi,
          Karnataka, India
        </div>
